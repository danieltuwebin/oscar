...
Class Persona
{
    ...
    {
        $sql="INSERT INTO persona (tipo_persona,nombre,tipo_documento,num_documento,contacto,direccion,telefono,email)
        VALUES ('$tipo_persona','$nombre','$tipo_documento','$num_documento','$contacto','$direccion','$telefono','$email')";
