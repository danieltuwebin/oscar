...
<!--Contenido-->
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Ingreso/Compra <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" style="height: 600px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <select class="form-control select-picker" name="condicioni" id="condicioni" required>
                               <option value="Contado">Contado</option>
                               <option value="Credito">Credito</option>
                               <option value="Prestamo">Prestamo</option>
                               <option value="Prestamo">Inventario</option>
                            </select>
                          </div>
                            ...
                            <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                              <thead style="background-color:#A9D0F5">
                                ...
                                <tfoot>
                                    ...
                                    <th></th>
                                    <th>TOTAL</th>
                                    <th><h4 id="total">US$.0.00</h4><input type="hidden" name="total_compra" id="total_compra"></th> 
  ...
  <!-- Modal -->
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" tyle="width: 1000px;" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 55% !important;">
      <div class="modal-content">
        ...
        <div class="modal-body" >
          <table id="tblarticulos" class="table table-striped table-bordered table-condensed table-hover" s>
            <thead>
                <th>Opciones</th>
                <th>Nombre</th>
                <th>Categoría</th>
